      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="flex justify-center">
            <div className="relative w-full max-w-xs h-80 bg-gradient-to-b from-yellow-50 to-purple-100 rounded-3xl border-8 border-gray-900 flex items-center justify-center overflow-hidden shadow-lg">
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="text-center lg:text-left">
              <p className="text-4xl sm:text-5xl font-black text-blue-900 leading-tight">60L +</p>
              <p className="text-gray-700 font-medium mt-2">Units Sold So Far</p>
            </div>

            {/* Stat 2 */}
            <div className="text-center lg:text-left">
              <p className="text-4xl sm:text-5xl font-black text-blue-900 leading-tight">7IK +</p>
              <p className="text-gray-700 font-medium mt-2">Stores, Eateries & Airports</p>
            </div>

            {/* Stat 3 */}
            <div className="text-center lg:text-left">
              <p className="text-4xl sm:text-5xl font-black text-blue-900 leading-tight">25 +</p>
              <p className="text-gray-700 font-medium mt-2">States & UT Covered</p>
            </div>

            {/* Stat 4 */}
            <div className="text-center lg:text-left">
              <p className="text-4xl sm:text-5xl font-black text-blue-900 leading-tight">10 +</p>
              <p className="text-gray-700 font-medium mt-2">International Locations Covered</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 pt-12 border-t-2 border-gray-900">
          <div className="bg-gradient-to-r from-blue-900 to-slate-800 rounded-3xl px-8 py-12">
