...
export default function ContactForm() {
  ...
  return (
    <>
      {/* ━━━ Dark Hero Banner (like Products page) ━━━ */}
      ...
      {/* ━━━ Contact Form + Info (White Background) ━━━ */}
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10 lg:gap-16 items-start">
            ...
            <div className="space-y-6">
              ...
              {/* Social Links Card */}
              <div className="bg-[#de3e4f] rounded-3xl p-8 text-white relative overflow-hidden">
                <div className="absolute -right-16 -bottom-16 w-48 h-48 bg-white rounded-full blur-[60px] opacity-10" />
                ...
                {/* <div className="flex gap-3 relative z-10">
                  {[
                    ...
                    <a
                      ...
                      href="#"
                      aria-label={label}
                      className="w-12 h-12 rounded-full bg-white/20 hover:bg-white hover:text-[#de3e4f] flex items-center justify-center transition-all duration-300 text-white hover:scale-110 hover:shadow-lg"
                    >
                      <Icon size={20} />
                    </a>
                  ))}
              ...
              {/* Email CTA */}
              <div className="bg-[#f5f5f7] rounded-3xl p-8 flex items-center gap-5 border border-gray-100">
                <div className="w-14 h-14 bg-white rounded-full flex items-center justify-center shrink-0 shadow-sm">
                  <Mail className="text-[#15161b] w-6 h-6" />
                </div>
                <div>
                  <p className={`${textFont.className} text-gray-400 text-xs font-bold uppercase tracking-widest mb-1`}>
                    Prefer email?
                  </p>
                  <p className={`${textFont.className} text-[#15161b] text-lg font-semibold`}>
